...
`gesaula-0.1.0-py3-none-any.whl` por la ruta real del archivo descargado.
...
.venv-gesaula\Scripts\python.exe -m pip install .\gesaula-0.1.0-py3-none-any.whl
...
.venv-gesaula/bin/python -m pip install ./gesaula-0.1.0-py3-none-any.whl
